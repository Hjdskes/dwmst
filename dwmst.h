...
#define VOL_HIGH_STR    "\uF357 %d%%"
#define VOL_MID_STR     "\uF359 %d%%"
#define VOL_LOW_STR     "\uF358 %d%%"
#define VOL_MUTE_STR    "\uF35A %d%%"

#define BAT_EMPTY_STR   "\uF212 %d%%, %02d:%02d"
#define BAT_LOW_STR     "\uF215 %d%%, %02d:%02d"
#define BAT_HIGH_STR    "\uF214 %d%%, %02d:%02d"
#define BAT_FULL_STR    "\uF213 %d%%, %02d:%02d"
#define BAT_CHRG_STR    "\uF211 %d%%, %02d:%02d"
